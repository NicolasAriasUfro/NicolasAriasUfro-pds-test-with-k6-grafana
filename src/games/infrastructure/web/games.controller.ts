...
import { UpdateGameDto } from '../../application/dto/update-game.dto';
...
export class GamesController {
  ...
  async create(@Body() createGameDto: CreateGameDto): Promise<Game> {
    return this.createGameUseCase.execute(createGameDto);
  }
  ...
  async update(
    ...
    return this.updateGameUseCase.execute(id, updateGameDto);
  }
